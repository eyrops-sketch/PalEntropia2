...
- presentación del ataque asignado
...
function mostrarAtaqueAsignadoArena(datos) {
    ...
    if (
        ...
        return `
            <div class="ataqueArena">
                ⚔️ Ataque: No disponible
            </div>
        `;
    ...
    try {
        ...
        if (
            typeof obtenerAtaqueAsignadoArena ===
            "function"
        ) {

            ataque =
                obtenerAtaqueAsignadoArena(
                    datos
                );
